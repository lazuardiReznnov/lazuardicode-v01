                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            >
                                ...
                                @if(old('category_letter_id',$data->category_letter_id)==$category->id)
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input
                                ...
                                name="loc_code"
                                value="{{ old('loc_code',$data->loc_code) }}"
                                required

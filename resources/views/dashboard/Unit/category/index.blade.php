<x-admin-layout title="{{ $title }}">
    ...
    <div class="row">
        <div class="col-md-6 my-3">
            <a
                href="/dashboard/unit/category/create"
                class="btn btn-sm btn-primary"
                ><i class="bi bi-file-earmark-plus"></i
            ></a>
            <a
                href="/dashboard/unit/category/create-excl"
                class="btn btn-sm btn-primary"
    ...
    <div class="row">
        <div class="col-md-10">
            <x-card header="List Category Unit">
                <table id="table" class="table table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a
                                    href="/dashboard/unit/category/{{ $data->slug }}/edit"
